...
const Footer4 = () => {
  return (
    <div className="bg-gray-900 mx-auto container w-full xl:px-20 lg:px-12 sm:px-6 px-4 px-4 py-12">
      <div className="flex flex-col items-center justify-center">
        <div className="w-1/3">
          <img src="https://firebasestorage.googleapis.com/v0/b/kyroswebsite.appspot.com/o/logo%2Fkyros%20signature.png?alt=media&token=28d0e8de-d1b1-4450-a2d8-0263614e3959" />
        </div>
        <div className="flex flex-wrap sm:gap-10 gap-8 items-center justify-center mt-8">
          <p className="hover:text-gray-200 text-base cursor-pointer leading-4 text-gray-400">
            About
          </p>
          <p className="hover:text-gray-200 text-base cursor-pointer leading-4 text-gray-400">
            Contact us
